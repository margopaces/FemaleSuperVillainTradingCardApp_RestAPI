...
@app.route("/api/villians/", methods=["GET"])
def get_villians():
...
def get_endpoints():
    endpoints = {
      "/api/villains/":"GET - Retrieves all villain data from database" ,
      "/api/villains/delete":"POST - Deletes an existing villian from the database" ,
